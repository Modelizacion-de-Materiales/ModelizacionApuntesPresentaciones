...
\input{./01-Problema/01-01-Problema}
\subsection{Discretización del Problema}
\input{./01-Problema/02-01-Discretizacion.tex}
\section{Matricialización del Probema}
\input{./02-Matriza/01-02-Ecuacion.tex}
\section{Condiciones de Contorno}
\subsection{ Borde a Temperatura Fija }
\input{./03-CondicionContorno/01-03-Borde-T}
\subsubsection{Vértices} 
\input{./03-CondicionContorno/02-03-vertices}
\section{Lógica}
\input{./04-Logica/01-04-Logica}
\section{Resultados con temperaturas Fijas}
\input{./05-Resultado1/01-05-Resultados1}
\section{Cálculo de Flujos}
\input{./06-CalculoFlujos/01-06-Flujos}
\section{Condiciones de contorno 2: Flujo dado}
\input{./07-CondicionesDeContorno2/01-07-BordeConFlujo}
\mode<all>
%
%\section{}
%\input{}
