...
\newcommand{\ecuacionb}{ x_1 (0) +  x_2(-k_2)+  x_3(k_2 + k_3) + x_4(-k_3)    &= F_3   }
\newcommand{\ecuacionbo}{  x_2(-k_2)  +  x_3(k_2 + k_3)  &= F_3  - (x_1 (0)    +  x_4(k_3) )}
\newcommand{\matriz}{
      \begin{pmatrix}
	k_1  & -k_1     & 0    & 0 \\
	-k_1 & k_1 +k_2 & -k_2 & 0 \\
...
\newcommand{\solvefb}{
  x_1 \cdot (0) + x_2 \cdot (0) + x_3 \cdot (-k_3) +x_4 \cdot (k_3) &= F_4
}
...
\input{./01-03-Elemento3.tex}

\subsection{Fuerzas Globales}

\input{./01-04-FuerzasGlobales}	

\section{Solucion de sistemas lineales mixtos}

\input{./02-01-Resolucion}

\input{./02-02-Fuerzas}

\section{Generalización}

\input{./03-01-Generalizacion}

\section{Programación}

\input{./04-01-Programacion}
