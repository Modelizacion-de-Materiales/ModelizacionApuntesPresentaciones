...
\column{0.25\textwidth}
  \textbf{Matlab}
    ...
    \lstinputlisting[language=Octave]{./CODEXAMPLES/Slice1.m}
  \column{0.45\textwidth}
  \textbf{Python}
    \lstinputlisting[language=Python]{./CODEXAMPLES/Slice1.py}
...
\column{0.25\textwidth}
    \lstinputlisting[language=Octave]{./CODEXAMPLES/Slices2.m}

  \column{0.45\textwidth}
    \lstinputlisting[language=Python]{./CODEXAMPLES/Slices2.py}
\end{columns}
\end{frame}
...
\begin{frame}<presentation>[label=FrameMatlabForWhile]{Control de Flujo}
  ...
  \begin{columns}[T]
    ...
    \column{0.4\textwidth}
	\lstinputlisting[language=Octave]{./CODEXAMPLES/suma_for.m}

    \column{0.4\textwidth}
	\lstinputlisting[language=Python]{./CODEXAMPLES/suma_for.py}
  ...
  \begin{columns}[T]
    ...
    \column{0.4\textwidth}
	\lstinputlisting[language=Octave]{./CODEXAMPLES/suma_while.m}

    \column{0.4\textwidth}
	\lstinputlisting[language=Python]{./CODEXAMPLES/suma_while.py}
...
\column{0.45\textwidth}
  \lstinputlisting[language=Octave]{./CODEXAMPLES/suma.m}

\column{0.45\textwidth}
\lstinputlisting[language=Octave]{./CODEXAMPLES/suma_continue.m}
...
\column{0.45\textwidth}
  \lstinputlisting[language=Python]{./CODEXAMPLES/suma.py}

\column{0.45\textwidth}
  \lstinputlisting[language=Python]{./CODEXAMPLES/suma_continue.py}
...
\begin{figure}
  \includeslide[width=\textwidth]{FramePythonIf}
