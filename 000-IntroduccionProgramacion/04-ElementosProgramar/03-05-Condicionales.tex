...
para combinar condiciones de ejecución. En la \autoref{FiguraTablaVerdad} tenemos una 
versión reducida de esta con las combinaciones básicas entre dos sentencias con algunos
ejemplos en \texttt{Matlab}

\begin{figure}
  \includeslide[width=\textwidth]{FrameTablaVerdad}
  \caption{Ejemplo de operaciones lógicas y tabla de verdad sencilla.
  \protect\label{FiguraTablaVerdad}}
\end{figure}
...
\begin{frame}<presentation>[label=FrameTablaVerdad]
  ...
  \begin{columns}[t]
    ...
    \column{0.5\textwidth}
      \begin{codeblock}
	\verbatiminput{CODEXAMPLES/TRUTH.m}
      \end{codeblock}
  \end{columns}
